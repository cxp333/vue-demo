...
<style scoped>
    ...
    .content h1{width:2.18rem;height:1.80rem; background:url(https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=2158902959,3512558600&fm=26&gp=0.jpg) no-repeat 0 0; background-size:100%; margin:0 auto; margin-top:1.22rem;}
