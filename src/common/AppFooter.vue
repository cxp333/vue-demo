<template>
  <div class="foot-btn" >
    <ul>
      ...
      <router-link tag="li" to="/scoremall" class="write" active-class="write2"><a href="javascript:;" ></a></router-link>
      <router-link tag="li" to="/user" class="my" active-class="my2"><a href="javascript:;" ></a></router-link>
...
.foot-btn ul .write{width:0.82rem;height:0.81rem; background:url(https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=298862292,2541067696&fm=27&gp=0.jpg) no-repeat 0 0; background-size:100%; margin-left:1.18rem;}
